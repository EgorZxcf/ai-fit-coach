            ...
            child: Column(
              ...
              children: [
                ...
                const Row(
                  ...
                  children: [
                    FeatureChip(icon: Icons.smart_toy_outlined, label: 'AI-тренер'),
                    FeatureChip(icon: Icons.show_chart, label: 'Прогресс'),
                    FeatureChip(icon: Icons.fitness_center, label: 'Планы'),
                  ],
                ),
                const SizedBox(height: 20),
                const Text(
